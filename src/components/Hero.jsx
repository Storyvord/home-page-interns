    ...
    return (
        <section className="flex items-center justify-between h-[640px] max-w-full bg-cover bg-center" style={{ backgroundImage: "url('https://storyvord.com/img/banner-bg.png')" }}>
            <div className="relative text-left flex-col p-0 px-3 py-4 lg:ml-24 xl:w-1/2 top-[-40px] text-white">
                ...
                <div className="mb-[-10px] mt-8 absolute">
                    <div className="h-48 w-96 mb-[-5px]">
                        <div className="flex flex-row justify-between bg-gradient-to-r from-[#03256c] to-green-500 py-4">
                            <button className="py-1 px-5 text-[18px] font-barlow font-extrabold text-left sm:mb-0 tracking-normal">Get In Touch
                            </button><img src="https://storyvord.com/img/right-arrow.svg" className="text-right px-5" alt="arrow" />
                        </div>
                        <div className="bg-white h-32 px-4 py-12">
                            <h2 className="uppercase text-[22px] font-barlow-2 font-bold text-[#092679] mt-2 mb-0">Are you a creator?</h2>
                            <p className="text-[16px] font-barlow-2 bg-gradient-to-r from-[#03256c] to-green-500 bg-clip-text text-transparent font-extrabold">Start Creating Now</p></div>
                    </div>
                </div>
            </div>
