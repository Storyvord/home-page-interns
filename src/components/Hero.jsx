            ...
            <div className="relative text-left flex-col p-0 px-3 py-4 lg:ml-24 xl:w-1/2 top-[-40px] text-white">
                ...
                <div className="mb-[-10px] mt-8 absolute">
                    <div className="h-48 w-96 mb-[-5px]">
                        ...
                        <div className="bg-white h-[165px] px-4 py-12 relative top-[40px] z-10 w-[30vw]">
                ...
                <div className="foot w-full h-20 bg-black relative top-[220px] right-[20%] flex items-end justify-end"></div>
                       <div className="foot w-full h-20 bg-black relative top-[140px] left-[80%] flex justify-between">
