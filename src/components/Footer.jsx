      ...
      <section className=' bg-black text-white overflow-hidden'>
        {/* Contact Us & Questions */}
         <div className='flex flex-col sm:flex-row sm:gap-16 md:gap-20 md:ml-1 sm:mr-3 md:mr-10 lg:ml-8 xl:ml-[5vw]'>
            ...
            <img src="https://storyvord.com/img/camera-stand-img.png" alt="image" className="w-full h-full absolute mix-blend-overlay object-cover"/>
            <img src="https://storyvord.com/img/line2.png" alt="image" className="w-full h-full absolute mix-blend-overlay object-cover"/>
            <div className="text-white p-5 pl-3 pr-10 lg:pl-10  mt-14 z-10">
            <h1 className=" font-bar_cd text-2xl md:text-4xl font-bold md:font-extrabold">CONTACT US</h1>
            <br />
            ...
            <img src="https://storyvord.com/img/footr-reel-img.svg" alt="image"
            ...
            <h1 className=" font-bar_cd text-2xl sm:text-3xl md:text-4xl font-bold text-white">HAVE A QUESTION?</h1>
            <br />
            <br />
         ...
         <div className=" w-full md:w-3/4 xl:w-[20vw] flex flex-col mx-auto xl:mx-0 justify-center mb-10">
          ...
          <div className=' mt-3 xsm:w-[30vw] xl:w-[14vw]'>
             <h1 className=" font-bar_cd sm:text-xl font-bold">LEGAL</h1>
          ...
          <div className='mt-3 w-[31vw] xsm:w-[25vw] md:w-[18vw] xl:w-[13vw]'>
            <h1 className=" font-bar_cd text-lg sm:text-xl font-bold">OUR LINKS</h1>
            <ul className=" mt-2 md:mt-4 font-josefin flex flex-col gap-2 text-sm sm:text-base">
          ...
          <div className=' mt-3 w-[30vw] xsm:w-[20vw] md:w-[15vw] xl:w-[10vw]'>
             <h1 className=" font-bar_cd text-lg sm:text-xl font-bold">LOCATIONS</h1>
             <ul className=" mt-2 md:mt-4 font-josefin flex flex-col gap-2 text-sm sm:text-base">
         ...
         <div className="text-white lg:ml-[75px] lg:mr-[75px] p-4 flex flex-col-reverse sm:flex-row gap-2 justify-between mx-auto">
          <p className=" font-josefin flex mx-auto sm:mx-0 text-center">© 2023 Storyvord Limited, All rights reserved</p>
